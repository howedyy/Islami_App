...
import 'package:islami_app/models/hadith_models.dart';
    ...
    return Container(
     ...
     margin: EdgeInsets.only(bottom: 20),
      decoration: BoxDecoration(
        image: DecorationImage(image: AssetImage(ImageAssets.hadithCardBg)),
          ...
          Stack(
            ...
            children: [
              Row(
                ...
                children: [
                  Image.asset(ImageAssets.suraDetailsPatternLeft, color: ColorsManager.black,),
                  Image.asset(ImageAssets.suraDetailsPatternRight, color: ColorsManager.black,),
              ...
              Text(
                ...
                style:
                TextStyle(
                    fontSize: 24,fontWeight: FontWeight.bold, color: ColorsManager.black
                ),
              )
            ],
          ),
          Expanded(
            child:hadith == null ? Center(
              child: CircularProgressIndicator(color: ColorsManager.black,)
                ...
                : SingleChildScrollView(
                  child: Text(
                                ...
                                style: TextStyle(
                    fontSize: 16,fontWeight: FontWeight.bold, color: ColorsManager.black)
                                ,),
                ),
          ),
          Image.asset(ImageAssets.hadithCardBottom)
